...
<a href="javascript:;" class="title box-title-action mt5" data-box="box-100004" class="desktop"><span class="fa fa-caret-right"></span> براساس تاریخ </a>
<div class="menu-container box-100004" >
<?php $where1=$_REQUEST['where']; $etoday= jdate("Y-m-d"); ?>
<a href="index.php?where=<?= $where1; if (empty($where1)){echo"soccer";} ?>&dataaa=<?= $etoday ?>" class="link">
<div class="left ml5"><div class="left"><?php echo jdate("Y/m/d l"); ?></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
</a>

<?php $threeDays1 = time() + (1 * 24 * 60 * 60);
$efarda= jdate("Y-m-d", $threeDays1); ?>
<a href="index.php?where=<?= $where1; if (empty($where1)){echo"soccer";} ?>&dataaa=<?= $efarda ?>" class="link">
<div class="left ml5"><div class="left"><? echo jdate("Y/m/d l", $threeDays1); ?></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
</a>
...
<?php $threeDays2 = time() + (2 * 24 * 60 * 60);
$epasfarda= jdate("Y-m-d", $threeDays2); ?>
<a href="index.php?where=<?= $where1; if (empty($where1)){echo"soccer";} ?>&dataaa=<?= $epasfarda ?>" class="link">
<div class="left ml5"><div class="left"><?  echo jdate("Y/m/d l", $threeDays2); ?></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
</a>

<?php $threeDays3 = time() + (3 * 24 * 60 * 60);
$epaspafarda= jdate("Y-m-d", $threeDays3); ?>
<a href="index.php?where=<?= $where1; if (empty($where1)){echo"soccer";} ?>&dataaa=<?= $epaspafarda ?>" class="link">
<div class="left ml5"><div class="left"><? echo jdate("Y/m/d l", $threeDays3); ?></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
</a>

<?php $threeDays4 = time() + (4 * 24 * 60 * 60);
$epasnimfarda= jdate("Y-m-d", $threeDays4); ?>
<a href="index.php?where=<?= $where1; if (empty($where1)){echo"soccer";} ?>&dataaa=<?= $epasnimfarda ?>" class="link">
<div class="left ml5"><div class="left"><?  echo jdate("Y/m/d l", $threeDays4); ?></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
</a>
...
<?php $threeDays5 = time() + (5 * 24 * 60 * 60);
$epasrifarda= jdate("Y-m-d", $threeDays5); ?>
<a href="index.php?where=<?= $where1; if (empty($where1)){echo"soccer";} ?>&dataaa=<?= $epasrifarda ?>" class="link">
<div class="left ml5"><div class="left"><? echo jdate("Y/m/d l", $threeDays5); ?></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
</a>
...
<?php if ($_REQUEST['where']=="forms"){}else{
...
<?php }?>				 
	...
	<?php  
if (strlen(text_check('get', 'where')) > 1) {
	if (file_exists('pages/' . text_check('get', 'where') . '.php')) include('pages/' . text_check('get', 'where') . '.php');
} 
if ($_REQUEST['where']==NULL){ include("pages/soccer2.php"); }
?>
